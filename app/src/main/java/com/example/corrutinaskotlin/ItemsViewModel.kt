...
class ItemsViewModel: ViewModel() {
    // flow --> se usa cuando son datos que van mutando a lo largo del ciclo de vida, cargar datos
    // em tiempo real, pq sino con el state solo tendriamos que estar modificando nosotros
